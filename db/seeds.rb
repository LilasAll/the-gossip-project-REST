...
10.times do
	User.create(last_name:Faker::Name.last_name, first_name:Faker::Name.first_name, email: Faker::Internet.email, age:rand(12..100), description:Faker::Quote.famous_last_words, city_id:City.all.sample.id)
end
puts "Users created"
